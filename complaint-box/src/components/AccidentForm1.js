...
function AccidentForm1() {
    return (
        <div className='divform1'>
            <section className='FormSec1'>
                <Form className='formmain'>
                    <h3 className='missing_comp'> Accident Complaint Form</h3>
                    ...
                    <Form.Control type="text" value="Accident" placeholder="Accident" className='formselect1' id='fms' disabled />
