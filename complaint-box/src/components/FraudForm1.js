        ...
        <div className='divform1'>
            <section className='FormSec1'>
                <Form className='formmain'>
                    <h3 className='missing_comp'> Fraud Complaint Form</h3>
                    ...
                    <Form.Control type="text" value="Fraud" placeholder="Fraud" className='formselect1' id='fms' disabled />
